...
class YOLO(object):
    ...
    def detect_image(self, image,cmodel = None,frame = None):
        start = timer()
        ...
        for i, c in reversed(list(enumerate(out_classes))):
            ...
            if cmodel != None:
                ...
                predictions = predictions = cmodel.predict(roi)[0]
            ...
            label_names = ["A157", "A293", "A417","B069","B216","B308","C116","T005","V138","V197","V273","V310"]
...
def detect_video(yolo, video_path, output_path=""):
    ...
    writer = cv2.VideoWriter("output.avi", 0, 22, (1280, 720), True)
    cmodel = load_model("lenet.hdf5")
    ...
    while True:
        ...
        image = yolo.detect_image(image,cmodel,frame)
